...
export default function FeaturedProducts({
  ...
  const defaultProducts = [
    ...
    },
    {
      ...
      descAr: "نظارات عصرية جذابة بتصميم مودرن للهنجمة والأناقة اليومية والمناسبات.",
      descEn: "Stylish fashion statement eyewear designed for casual wear and trend-setting look.",
      sku: "AFP-FAS-404",
      price: 55,
      isAvailable: true,
      categorySlug: "fashion-glasses",
      categoryName: isArabic ? "نظارات هنجمة واستعراض" : "Fashion Eyewear",
      brandName: "Ray-Ban",
      imageUrl: "/brand/logo-primary.png",
    },
    {
  ...
  const filterTabs = [
    ...
    { id: "fashion-glasses", labelAr: "نظارات هنجمة واستعراض", labelEn: "Fashion & Casual", icon: Sparkles },
